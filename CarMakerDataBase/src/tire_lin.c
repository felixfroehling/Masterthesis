...
*   mex '-I/opt/ipg/carmaker/linux64-9.0/include' '-DLINUX' tire_lin.c
*   mex '-I/opt/ipg/carmaker/linux64-9.0/include' '-DWIN32' tire_lin.c
* Compile in 64-bit Matlab with one of
*   mex '-I/opt/ipg/carmaker/linux64-9.0/include' '-DLINUX' '-DLINUX64' tire_lin.c
*   mex '-I/opt/ipg/carmaker/linux64-9.0/include' '-DWIN32' '-DWIN64'   tire_lin.c
*/
