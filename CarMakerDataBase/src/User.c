...
User_TestRun_Start_atEnd (void)
{
    ...
    sprintf(file, "/home/felix/Documents/Master/SimOutput/%d%02d%02d-%02d%02d.txt", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min);
        ...
        if (nObj>0) {
            ...
            for(int idx = 0; idx < 49; idx++) {
                ...
                if (Obj.Type>=0) {
                    ...
                    //Debug Ausgaben
                    //printf ("geschw: %.2f %.2f    %.2f %.2f    %.2f %.2f\n", SpeedRefx, SpeedRefy, SpeedRefz, SpeedNearx, SpeedNeary, SpeedNearz);
                    //printf("Speed: %.2f\n", speedRadial);
                    //printf("winkel: %.2f\n", yaw);
                    //printf("dist:  %.2f\n", dist);
                    printf("dist:  %.2f\n", distX);
