...
static const char *CompileLibs[] = {
    /* /net/dagobert/local/work.fh/cm90d/src_lib/Portings/linux64/lib/libcar4sl.a */
    /* /net/dagobert/local/work.fh/cm90d/src_lib/Portings/linux64/lib/libcarmaker4sl.a */
    ...
    "libcar4sl.a	CarMaker-Car linux64 9.0 2020-05-15",
    "libcarmaker4sl.a	CarMaker linux64 9.0 2020-05-15",
...
static const char *CompileFlags[] = {
    ...
    "-D_FILE_OFFSET_BITS=64 -DCM_NUMVER=90000 -DMYMODELS",
...
tAppStartInfo   AppStartInfo = {
    ...
    "408",          /* App_BuildVersion    */
    "fh",     /* App_CompileUser     */
    "obelix.ipg",         /* App_CompileSystem   */
    "2020-05-15 16:22:27",  /* App_CompileTime */
